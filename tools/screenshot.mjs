...
const SHOTS = {
  ...
  kitchen_island: [4.9, 0, -0.35, Math.PI, 0.2, 0.16, 3.2],
  kitchen_sink: [4.5, 0, -4.4, Math.PI, -0.4, 0.12, 2.2],
  ...
  bedroom3: [5, 3.05, 3.2, Math.PI, 0.15, 0.15, 2.6],
  bath: [2.5, 3.05, 0.4, Math.PI / 2, -Math.PI / 2, 0.15, 2.6],
  bedroom4: [5, 3.05, -4, Math.PI, 0.2, 0.15, 2.2],
